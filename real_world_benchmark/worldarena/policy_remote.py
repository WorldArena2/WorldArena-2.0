...
from real_world_benchmark.worldarena.bridges.legacy_policy import (
...
from real_world_benchmark.worldarena.schema import ActionPacket, ObservationPacket
from real_world_benchmark.worldarena.serde import action_from_message, observation_from_message, pack_message, unpack_message
from real_world_benchmark.worldarena.ws_util import connect_websocket, normalize_websocket_uri
...
def dispatch_policy_endpoint(
    ...
    *,
    ...
    from real_world_benchmark.worldarena.serde import observation_from_message
    ...
    if endpoint == POLICY_ENDPOINT_INFER:
        from real_world_benchmark.worldarena.action_debug import log_pipeline_trace
...
class CanonicalPolicyClient:
    ...
    def infer_policy_result(self, observation_packet: ObservationPacket) -> 'PolicyInferResult':
        from real_world_benchmark.worldarena.bridges.legacy_policy import parse_policy_infer_full
