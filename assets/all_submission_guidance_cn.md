...
本文档仅汇总三个赛道的详细文档入口。请选择对应赛道，并按照详细文档准备提交内容。

## Track 1：视频质量

将生成视频和模型元信息提交到公开的 Hugging Face dataset 仓库。

- [Track 1 Hugging Face 提交规范](https://github.com/WorldArena2/WorldArena-2.0/blob/main/assets/TRACK1_HF_SUBMISSION_GUIDELINE_CN.md)
