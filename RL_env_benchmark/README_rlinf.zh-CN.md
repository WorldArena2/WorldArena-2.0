...
仓库中的示例配置应避免提交私有机器路径、用户名、内部挂载点和 API key。本地数据集、checkpoint、reward model 和仿真器资源请通过环境变量或文档中的占位符配置。
...
世界模型训练和接入流程见 [`README_WORLD_MODEL_ENV.md`](README_WORLD_MODEL_ENV.md)。
