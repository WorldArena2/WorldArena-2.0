...
from rlinf.models.embodiment.reward.lpips_reward_model import LPIPSLastFrameRewardModel
...
reward_model_registry = {
    ...
    "lpips_last_frame": LPIPSLastFrameRewardModel,
